...
const ImgUploadAndLists = () => {
  const { sizeColorStockImgArr, removeColorFromList, removeSizeFromList } =
            ...
            >
                  ...
                  >
                    ...
                    <span className="absolute right-5 top-1">
                      <Delete
                        ...
                        onClick={() =>
                          removeColorFromList(item.size, info.color)
                        }
                      />
                    </span>
              ...
              <div>
                <MdDeleteForever
                  ...
                  onClick={() => removeSizeFromList(item.size)}
                />
              </div>
            </div>
          ))
...
export default ImgUploadAndLists;
