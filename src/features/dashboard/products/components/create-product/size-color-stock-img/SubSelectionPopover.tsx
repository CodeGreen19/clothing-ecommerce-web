...
import { ProductToolTip } from "../../shared/tooltip";
import { useSizeColorStockImgStore } from "../../../store/use-product-create";
import { ALL_POSSIBLE_COLORS } from "../../../constants";
const SubSelectionPopover = () => {
  //hooks
  const { selectedSize, setColorAndStock } = useSizeColorStockImgStore();
  // states
  const [isColorPopoverOpen, setIsColorPopoeverOpen] = useState(false);
...
export default SubSelectionPopover;
